...
Пусть \(\mc{P} \subset k[X]\) --- это множество унитальных минимальных многочленов над \(k\) элементов \(B\).
...
Воспользовавшись леммой~\secref{lem:noeth} отсюда можно вывести существование элемента
\(\alpha \in \sum_{\beta \in B} k \beta\),
такого что отображение
