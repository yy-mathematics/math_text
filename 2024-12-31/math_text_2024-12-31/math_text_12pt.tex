...
%\usepackage{math_text_style}

\usepackage{math_text_layout_12pt_crop}
...
\textenglish{Creative Commons Zero v1.0 Universal}.
Значки: \cczero.
...
\begin{remark}
Символ <<\(\in\)>> происходит от повёрнутой на \(180^{\circ}\) кириллической буквы <<э>>, первой буквы слова <<это>>: <<\(x \in \R\)>> --- <<\(x\) --- это вещественное число>>. Шутка. На самом деле это повёрнутая на \(180^{\circ}\) греческая буква \(\epsilon\), первая буква слова <<ἐστί>> --- <<ѥстъ>>/<<єстъ>>/<<есть>>.
\end{remark}

\begin{convention}[\scshape Кольцо] \label{con:Ring}
...
Решения уравнения \((s_{\mathrm{ort}} x s_{\mathrm{ort}}^{-1})^{\transpose} = -x\) легко описать, заметив, что сопряжение матрицей \(s_{\mathrm{ort}}\) заменяет матрицу на <<центрально симметричную>>, что в композиции с транспонированием даёт отражение матрицы относительно побочной диагонали.
Отсюда, в частности, становится ясно, что размерность ортогональной алгебры Ли при \(\charact(K) \neq 2\) равна \((1/2)(n^2 - n)\).
Решения уравнения \((s_{\mathrm{sp}} x s_{\mathrm{sp}}^{-1})^{\transpose} = -x\) легко описать, заметив, что
\(
\begin{psmallmatrix*}[r]
    -1 & 0 \\
    0 & 1
...
Преобразование \([e_{i,i},-]\) умножает все матричные единицы \(e_{i,j}\), где \(j \in I \setminus \{i\}\), на \(1\), матричные единицы \(e_{j,i}\), где \(j \in I \setminus \{i\}\), --- на \(-1\), а остальные --- на \(0\).
Отсюда ясно, что
...
Аналогичным образом проверяется, что в ортогональной и симплектической алгебрах Ли очевидный базис в пространстве диагональных матриц является ортогональным базисом относительно формы Киллинга, откуда становятся ясными картинки соответствующих систем корней.
\end{remark}
...
(x_n)_{n \in \N_1}
\mapsto
\textstyle\prod_{n \geqslant 1} (1 - x_n t^n).
\]
Коэффициенты ряда
...
\begin{definition}[\scshape Гиперболическое и анизотропное пространства]
...
\begin{figure}[ht]
    \centering
%    \captionsetup{labelsep=colon}
	\begin{tikzpicture}[scale=1, x=1.9cm, y=1.9cm]
...
%Пусть \(A\) --- область целостности, пусть \(Aa + Ab = Ac \neq 0\), где \(a,b,c \in A\), то есть существуют \(c_a,a_c,b_c \in A\), такие что \(c_a a + c_b b = c\), \(a_c c = a\), \(b_c c = b\). Тогда
%\(
%(
%\begin{smallmatrix}
%    c \\
...
Пусть
\(
M \cong A^m \oplus \bigoplus_{\mathfrak{p} \in \mathcal{P}} \bigoplus_{i = 1}^{N_\mathfrak{p}} A/{\mathfrak{p}}^{n_{\mathfrak{p},i}}
\),
...
\begin{observation}
Пусть \(B \coloneqq A[X]/(P(X))\), где \(A\) --- ассоциативное коммутативное унитальное кольцо, а \(P(X) \in A[X]\) --- унитарный многочлен. Пусть \(x \in B\) --- это образ \(X \in A[X]\).
...
\begin{proof}
Из теоремы Гамильтона\namedash{}Кэли следует, что существует унитарный многочлен \(P(X) = \sum_{i=0}^n a_i X^i \in A[X]\) минимальной степени \(n \in \N_1\), такой что \(P(\iota) = 0\). Воспользовавшись тем, что на \(\iota\) можно сокращать слева, легко заметить, что \(a_0 \neq 0\).
...
Пусть \((X_i)_{i \in I}\), \((Y_i)_{i \in I}\) и \((U_{i,\alpha})_{i \in I, \alpha \in \Omega}\) --- три семейства множеств, такие что \(Y_i, U_{i,\alpha} \subset X_i\) для любых \(i \in I\) и \(\alpha \in \Omega\), причём \(\prod_{i \in I} Y_i \subset \bigcup_{\alpha \in \Omega} \prod_{i \in I} U_{i,\alpha}\).
...
%\begin{proof}
%Композиция замкнутых отображений, очевидно, замкнута.
%Нам нужно доказать, что для любой точки \(z \in Z\) множество \(K \coloneqq f^{-1}(g^{-1}(z)) \subset X\) компактно.
%Согласно лемме~\ref{lem:ClosedSubsComp} множество \(K' \coloneqq g^{-1}(z) \cap f(X) \subset Y\) компактно как замкнутое подмножество компактного по условию множества \(g^{-1}(z) \subset Y\).
%Согласно лемме~\ref{lem:ClosedCompImCompFib} множество \(K\) компактно, так как \(x \mapsto f(x) : K \to K'\) --- сюръективное и замкнутое по наблюдению~\ref{obs:ClosedMapRestr} отображение с компактными слоями и компактным образом.
%\end{proof}
...
%а пуллбэк замкнутого отображения вдоль вложения подмножества с индуцированной топологией всегда является замкнутым отображением.
%
%\end{description}
\end{proof}
...
\begin{observation}
\label{obs:im-closed}
Пусть \(X\) и \(Y\) --- топологические пространства, \(f : X \to Y\) --- отображение. Отображение \(f\) непрерывно тогда и только тогда, когда \(f(\Cl(S)) \subset \Cl(f(S))\) для любого \(S \subset X\).
Отображение \(f\) замкнуто тогда и только тогда, когда \(f(\Cl(S)) \supset \Cl(f(S))\) для любого \(S \subset X\).
\end{observation}
...
Предположим, что \(J \neq I\).
Для любого \(e \in I \setminus J\) отображение \(f^{J \cup \{e\}}_J\) замкнуто, так как отображение \(f_e\) собственно, а потому \(b \in \Cl(S_J)\) можно поднять до элемента множества \(\Cl(S_{J \cup \{e\}})\) --- противоречие.
\qedhere
...
\begin{theorem}[\scshape Характеризации метрической полноты] \label{thm:ComplMetrSpace}
Пусть \(X\) --- метрическое пространство. Тогда следующие два условия эквивалентны.
\begin{enumerate}[
	font=\upshape,
	label=\asbuk*),
	ref=\asbuk*,
...
\begin{notation}
<<Полугруппа*>> --- это \rusquoted{полугруппа}, совокупность элементов которой не подразумевается малой, то есть не подразумевается множеством. Обозначения <<отображение*>> и <<категория*>> имеют аналогичный смысл.
\end{notation}

\begin{definition}
\label{def:SemigroupEin}
Пусть \(\mc{C}\) --- мультипликативная полугруппа* с нулём. Определим
...
\begin{definition}[\scshape Категория*]
...
\begin{definition}[\scshape Область и кообласть]
\label{def:SourceTarget}
Пусть \(\mc{C}\) --- категория*. Определим
...
%\begin{definition}[\scshape Ординал]
%\label{def:ZornLemmaOrdinal}
%Линейно упорядоченное множество \(X\), такое что в линейно упорядоченном множестве \([1]^X\) у любого не максимального элемента есть последующий, называется \emph{ординалом}.
%\end{definition}

%\begin{remark}
%Ординал в определении~\ref{def:ZornLemmaOrdinal} --- это то же самое, что фундированное линейно упорядоченное множество.
%\end{remark}
...
Теорема~\ref{thm:OrdZornLemma} допускает следующую эквивалентную переформулировку, называемую \emph{принципом максимума Хаусдорфа}: <<В любом частично упорядоченном множестве существует максимальная по включению цепь>>.
\end{observation}
...
\begin{theorem}[\scshape Неравенство Лагранжа]
\label{thm:LagrIneq}
...
\begin{theorem}
Пусть \(E\) --- это евклидово пространство,
а \(\varphi : E \to E\) --- это дифференцируемое отображение, такое что \(\varphi(0) = 0\), отображение \(D(\varphi)_0\) биективно,
а отображение
...
\(f(0) = 0\), вторая частная производная
\(\6_2 \6_1 f\)
...
\begin{proof}
Применяя правило Лейбница, получаем равенство
...
\begin{theorem}[\scshape Лемма Адамара]
...
\subsection{Основная теорема теории групп}
...
\begin{observation}[\scshape Основная теорема]
...
\subsection{Приложения основной теоремы}

\begin{observation}[\scshape Разложение группы на двойные смежные классы] \label{obs:DoubleCosets}
...
\begin{theorem} \label{thm:AutSymTransInner}
...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    \centering
    \newcommand\myL{1.2*0.7654}
    \newcommand\n{5}
    \newcommand\dTheta{360/\n}
    \newcommand\RotAngle{90}
    \tikzset{
      every node/.style={draw,fill,circle,minimum size=4pt,inner sep=-2pt,},
      label distance=2.5mm,
    }
    \raisebox{\dimexpr1.1087cm}{%
    \begin{tikzpicture}
      \node[] (V1) at (0*\myL,0){};
      \node[] (V2) at (1*\myL,0){};
      \node[] (V3) at (2*\myL,0){};
...
\begin{theorem}\label{thm:MatrixTensorMorita}
Пусть $R$ --- ассоциативное унитальное кольцо,
...
Пусть \(R\) --- ассоциативное унитальное кольцо, а \(I\) --- конечное непустое множество. Тогда из теоремы~\ref{thm:MatrixTensorMorita} ясно, что функторы \(V \mapsto \Mat_{I, \pt}(R) \otimes_R V : R\tn{-}\mr{mod} \rlarrow \Mat_I(R)\tn{-}\mr{mod} : \Mat_{\pt, I}(R) \otimes_{\Mat_I(R)} U \mapsfrom U\)
задают эквивалентность категорий \(R\tn{-}\mr{mod}\) и \(\Mat_I(R)\tn{-}\mr{mod}\).
\end{observation}

\begin{observation}
Пусть \(R\) --- ассоциативное унитальное кольцо, \(I\) --- конечное непустое множество, \(U\) --- \(\Mat_I(R)\)-мо\-дуль, а \((e_{i,j})_{i,j \in I}\) --- стандартный базис \(\Mat_I(R)\) как \(R\)-мо\-ду\-ля.
...
Пусть \(R\) --- ассоциативное унитальное кольцо, а \(I\) --- конечное непустое множество.
Тогда \(\Zent(\Mat_I(R)) \cong \Zent(R)\) и \(\Zent_{\Mat_I(R)}(\Elem_I(\Z)) \cong R\).
...
Централизатор \(\Elem_I(\Z)\) в \(\Mat_I(R)\) совпадает с централизатором \(\Z\)-подалгебры в \(\Mat_I(R)\), порождённой \(\Elem_I(\Z)\), которая совпадает с \(\Mat_I(\Z)\).
Равенство \(\Zent(\GL_1(R)) = \Zent(R^{\times})\) очевидно.
Если \(\card(I) > 1\), то \(\Zent(\GL_I(R)) = \Zent_{\Mat_I(R)}(\Z\langle x \smid x \in \GL_I(R) \rangle)^{\times} = \Zent_{\Mat_I(R)}(\Z\langle x \smid x \in \Elem_I(R) \rangle)^{\times} = \Zent_{\Mat_I(R)}(\Mat_I(R))^{\times} = \Zent(R)^{\times}\).
\end{proof}
...
\begin{proof}
Пусть \(S \coloneqq R \otimes_{\Z} R^o\).
Заметим, что \(\Mat_I(R) \cong R^{I \times I}\) как модуль над \(\Mat_I(R) \otimes_{\Z} \Mat_I(R)^o \cong \Mat_{I \times I} (S)\), а эквивалентность из наблюдений~\ref{obs:MatrixMoritaEq} и \ref{obs:MatrixMoritaEqAlt} переводит \(S\)-мо\-дуль \(R\) в \(\Mat_{I \times I}(S)\)-мо\-дуль \(S^{I \times I} \otimes_S R \cong R^{I \times I}\). 
\end{proof}
...
Так как \(M\) артинов, то продолжая таким образом, мы за конечное число шагов дойдём до нуля и получим композиционный ряд.
...
\begin{theorem}[\scshape Полупростота подфакторов]\label{thm:semisim_sub_factor}
...
\begin{theorem}[\scshape Критерий полупростоты]\label{thm:semisimple_simple_sum}
...
Полупростой модуль \(M\) над ассоциативным унитальным кольцом \(R\) называется \emph{изотипическим}, если у него ровно одна ненулевая изотипическая компонента.
\end{definition}
...
Пусть \(N\) --- простой модуль над ассоциативным унитальным кольцом \(R\), а \(V\) --- модуль над \(D \coloneqq \End_{R\module}(N)^o\).
Тогда любой \(R\)-под\-мо\-дуль в \(N \otimes_D V\) имеет вид \(N \otimes_D U\), где \(U \subset V\) --- \(D\)-под\-мо\-дуль.
\end{corollary}
...
Ядро структурного гомоморфизма \(R \to \End_{\Z\tn{-}\mr{mod}}(M)\) называется \emph{аннулятором} \(M\) в \(R\) и обозначается \(\Ann_R(M)\).
\end{definition}

\begin{definition}[\scshape Радикал Джекобсона кольца]
Пусть \(R\) --- ассоциативное унитальное кольцо.
Пересечение аннуляторов простых \(R\)-мо\-ду\-лей называется \emph{радикалом Джекобсона} кольца \(R\).
\end{definition}
...
По наблюдению~\ref{obs:ArtinFamilyInter} существует конечное семейство \((M_i)_{i \in I}\) максимальных собственных подмодулей \(M\), такое что \(\mf{J}_M = \bigcap_{i \in I} M_i\).
...
\begin{theorem} \label{thm:GalIsoTwo}
...
%В этом подразделе считается, что минимальные многочлены элементов расширений полей унитарны, то есть имеют старший коэффициент \(1\).
%\end{convention}

\begin{lemma} \label{lem:PrimFieldDiag}
...
\begin{proof}
Зафиксировав изоморфизм \(E \xrightarrow{\sim} k[X]/P(X)\) и заметив, что так как
\(\lvert \Hom_{k\ring}(E,K) \rvert = [E : k]\),
то \((P(X)) = (\prod_{\alpha \in S} (X - \alpha))\) в \(K[X]\), где \(S \subset K\),
получаем следующую цепочку изоморфизмов:
\(
K \otimes_k E
\xrightarrow{\sim}
K \otimes_k (k[X]/P(X))
...
поэтому, согласно лемме~\ref{lem:PrimFieldDiag}, имеем следующий изоморфизм \(K\)-ал\-ге\-бр:
...
Естественно, из условия теоремы также следует, что для произвольного \(\varphi \in \Hom_{E_0\ring}(E_1,K)\)
выполняется равенство
...
Выберем башню полей
\(k = E_0 \subset E_1 \subset \cdots{} \subset E_n = E\),
такую что \(E_i \coloneqq E_{i-1}[x_i] \xleftarrow{\sim} E_{i-1}[X_i] /P_i(X_i) : x_i \mapsfrom X_i\) и \(P(x_i)=0\) для любого \(i = 1, \dots{}, n\).
...
%
%\begin{proof}
%Так как \([K : k] < \infty\), то \(K\) как \(k\)-алгебра порождено конечным множеством \(S \subset K\). Пусть \(\mc{P} \subset k[X]\) --- множество унитарных минимальных многочленов над \(k\) элементов \(S\). Тогда \(K\) является полем разложения сепарабельного многочлена \(\prod_{P(X) \in \mc{P}} P(X) \in k[X]\).
%\end{proof}

\begin{observation}
Пусть \(E/k\) --- конечное сепарабельное расширение полей, \(\mc{P} \subset k[X]\) --- множество унитарных минимальных многочленов над \(k\) элементов какого-то фиксированного базиса \(E\) над \(k\),
...
или, эквивалентно,
\(b\) является корнем унитарного многочлена с коэффициентами в \(A\), то есть
...
\begin{definition}[\scshape Кофинальный функтор]
...
\begin{observation}[\scshape Функториальность жорданова разложения]
...
Любой ненулевой главный идеал области главных идеалов однозначно представляется в виде конечного произведения ненулевых простых главных идеалов.
...
\begin{observation}[\scshape Предаддитивная категория]
...
%\begin{remark}
%Иллюстрация к наблюдению \ref{obs:PreaddCatLim}:
%\begin{equation*}
%\begin{tikzcd}[column sep=small]
%&
%(A \times 0) \sqcup (0 \times B) \ar{rr} \ar{d} &
%&
%(A \sqcup 0) \times (0 \sqcup B) \ar{d} &
%A \times B \ar[swap, equal]{l}{\sim} \\
%A \sqcup B &
%(A \times 1) \sqcup (1 \times B) \ar{rr} \ar[swap, equal]{l}{\sim} &
%&
%(A \sqcup 1) \times (1 \sqcup B)\mathrlap{.}
%\end{tikzcd}
%\end{equation*}
%\end{remark}
